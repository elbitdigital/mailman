...
class RotasulResponse extends Response {
...
$mailer->setFrom('mailman@service.elbit.com.br', 'Rotasul - MailMan');
...
$mailer->isHTML(true);
$mailer->Subject = 'Requisição de contato - Rotasul';
...
$response = new RotasulResponse($_GET, $mailer);
